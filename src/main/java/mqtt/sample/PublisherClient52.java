...
public class PublisherClient52 {

    private static final Logger log = LoggerFactory.getLogger(App.class);

    private static final int qos = 0;
    private static String broker = "tcp://192.168.123.52:41883";
    private static String clientId = "publisher_client52";
    ...
    public static void main(String[] args) throws Exception{
        ...
        String pubTopic = "topic/msg52";
        String content = "메시지좀 받아라52";

        // MQTT connection option
        MqttConnectOptions connOpts = new MqttConnectOptions();
        connOpts.setUserName("publisher_user52");
